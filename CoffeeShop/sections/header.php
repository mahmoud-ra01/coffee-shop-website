...
<header>
   <a href="#" class="logo"><i class="fa-solid fa-mug-saucer"></i></i>Coffee Shop.</a>
    ...
    <?php
        ...
        if(isset($_SESSION["currency"])){
            ...
            <a href="./wishlist.php" class="fa-regular fa-star"></a>
            <a href="./cart.php" class="fa-solid fa-cart-plus"></i></a>
